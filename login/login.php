<?php session_start();
 require '../core/function.php';  $row = '';   $msg = '';
            ...
            <div class="container">
                <div class="signin-content">
                    <div class="signin-image">
                        ...
                        <a href="../Registration/Register.php" class="signup-image-link">Create an account</a>
                    </div>
                    ...
                    <div class="signin-form">
                        ...
                        <form method="POST" class="register-form" id="login-form">
                            <div class="form-group">
                                ...
                                <input type="text" name="email" placeholder="Email" id="your_name" required  />
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group form-button">
                                <input type="submit" name="btn_submit" id="signin" class="form-submit" value="Log in"/>
                            </div>
                            <p class="message">Forgotten Password? <a href="../core/forgot_password.php">Click here</a></p>
                        </form>
