            ...
            <div class="col-lg-6 col-6 text-left">
                <form role="search" method="get" action="search_results.php">
                    <div class="input-group">
                        <input type="text" class="form-control" placeholder="Search for products" name="search_key">
                        <div class="input-group-append">
                            <span class="input-group-text bg-transparent " >
                           <button class="text-primary" style="border:none;" type="submit"> <i class="fa fa-search" ></i></button>
                            </span>
                        </div>
                    </div>
                </form>
